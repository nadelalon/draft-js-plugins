      ...
      _defineProperty(
        ...
        function() {
          ...
          setTimeout(function() {
            ...
            var selectionRect = draftJs.getVisibleSelectionRect(
              parentWindow || window
            );
  ...
  children: function children(externalProps) {
    return (
      ...
      React.createElement(
        'div',
        null,
        React.createElement(draftJsButtons.ItalicButton, externalProps),
        React.createElement(draftJsButtons.BoldButton, externalProps),
        React.createElement(draftJsButtons.UnderlineButton, externalProps),
        React.createElement(draftJsButtons.CodeButton, externalProps)
      )
    );
  },
});
